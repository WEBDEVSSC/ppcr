...
@section('content_header')
    <h1><strong>Parametros</strong> <small>Nuevo registro</small></h1>
@stop
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="meta_anual" id="meta_anual" class="form-control" value="{{ old('meta_anual') }}">
                    @error('anio')<br><p class="text-danger">{{ $message }}</p>@enderror
                </div>
            ...
            <div class="row mt-3">
                <div class="col-md-3">
                    ...
                    <input type="number" name="metaj1" id="metaj1" class="form-control" value="{{ old('metaj1') }}">
                    @error('metaj1')<br><p class="text-danger">{{ $message }}</p>@enderror
                </div>
                <div class="col-md-3">
                    <p><strong>Meta J2</strong></p>
                    <input type="number" name="metaj2" id="metaj2" class="form-control" value="{{ old('metaj2') }}">
                    @error('metaj2')<br><p class="text-danger">{{ $message }}</p>@enderror
                </div>
                <div class="col-md-3">
                    <p><strong>Meta J3</strong></p>
                    <input type="number" name="metaj3" id="metaj3" class="form-control" value="{{ old('metaj3') }}">
                    @error('metaj3')<br><p class="text-danger">{{ $message }}</p>@enderror
                </div>
                <div class="col-md-3">
                    <p><strong>Meta J4</strong></p>
                    <input type="number" name="metaj4" id="metaj4" class="form-control" value="{{ old('metaj4') }}">
            ...
            <div class="row mt-3">
                <div class="col-md-3">
                    ...
                    <input type="number" name="metaj5" id="metaj5" class="form-control" value="{{ old('metaj5') }}">
                    @error('metaj5')<br><p class="text-danger">{{ $message }}</p>@enderror
                </div>
                <div class="col-md-3">
                    <p><strong>Meta J6</strong></p>
                    <input type="number" name="metaj6" id="metaj6" class="form-control" value="{{ old('metaj6') }}">
                    @error('metaj6')<br><p class="text-danger">{{ $message }}</p>@enderror
                </div>
                <div class="col-md-3">
                    <p><strong>Meta J7</strong></p>
                    <input type="number" name="metaj7" id="metaj7" class="form-control" value="{{ old('metaj7') }}">
                    @error('metaj7')<br><p class="text-danger">{{ $message }}</p>@enderror
                </div>
                <div class="col-md-3">
                    <p><strong>Meta J8</strong></p>
                    <input type="number" name="metaj8" id="metaj8" class="form-control" value="{{ old('metaj8') }}">
